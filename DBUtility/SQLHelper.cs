...
namespace Hangjing.DBUtility
{
    public abstract class SQLHelper
    {
        ...
        {
            ConnectionString =SQLHelper.Configuration.GetConnectionString("sqlsugar");
        ...
        */
        ...
        /// <param name="strTop">数据条数</param>
        /// <returns>数据表</returns>
        public static DataTable SelectByWhere(string strTableName, string strWhere, string strOrder, string strTop)
        {
            SqlCommand cmd = new SqlCommand();
            ...
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
				...
				{
                    new SqlParameter("@Str_Top",strTop),
					new SqlParameter("@Table_Name",strTableName),
					new SqlParameter("@Table_Where",strWhere),
					new SqlParameter("@Table_Order",strOrder)
				};
                PrepareCommand(cmd, connection, null, CommandType.StoredProcedure, "CO_Select_Public", param);
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                adp.Fill(dt);
                cmd.Parameters.Clear();
        ...
        /// 条件查询(直接输入整个Sql语句)
        /// </summary>
        /// <param name="strSql">整条Sql语句</param>
        /// <returns>数据表</returns>
        public static DataTable SelectByWhere(string strSql)
        {
            SqlCommand cmd = new SqlCommand();
            ...
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
                SqlParameter[] param = new SqlParameter[]
				{
                    new SqlParameter("@Sql_String",strSql)
				};
                PrepareCommand(cmd, connection, null, CommandType.StoredProcedure, "CO_Select_Public_String", param);
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                adp.Fill(dt);
                cmd.Parameters.Clear();
